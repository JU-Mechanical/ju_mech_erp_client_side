...
export default function AdminPortal() {
    ...
    const [activeComponent, setActiveComponent] = useState("ManageProfiles");
    ...
    return (
        ...
        >
            <Navbar />
            <Box sx={{ display: "flex", height: "calc(100vh - 64px)", mt: "64px", alignContents:'center', justifyContent:'center' }}>
                {/* Main Content Area */}
