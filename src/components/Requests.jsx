...
const Requests = () => {
  ...
  useEffect(() => {
    const getreqs = async () => {
      ...
      console.log(data);
      const response = await fetch("https://jumechserver.onrender.com/users/getreqs", {
        method: "POST",
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://jumechserver.onrender.com/users/createreq", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  return (
    ...
    >
      <Typography
        sx={{ fontWeight: "bold", color: "#b70924", fontSize: "40px" }}
      >
        Requests
      </Typography>
      ...
      >
        {requests.length === 0 && (
          ...
          >
            ...
            />
            <Typography
              sx={{ color: "#757575", fontSize: "18px", fontWeight: "bold" }}
            >
      ...
      >
        ...
        >
          ...
          >
            <Typography
              variant="h5"
              sx={{ fontWeight: "bold", color: "#b70924" }}
            >
              Fill out the Form
            </Typography>
            <TextField
